module.exports = {
    ...
    downloads: {
        storageDirectory: '/Users/mantro/Documents/libs', // optional, the specific directory to store the flyway downloaded files. The directory must be writable by the node app process' user.
